...
public class BlockDustOre extends Block implements IBlockVariants
{
  ...
  {
    return BMItems.item_materials.get(EnumMaterialItem.DUST);
  }

  @Override
  public int damageDropped(IBlockState state)
  {
    return BMItems.item_materials.get(EnumMaterialItem.DUST).getMaterialMeta(state.getValue(VARIANT).material);
  }
